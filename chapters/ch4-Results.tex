...
Figure~\ref{fig:ComfAgentic}\subref{fig:ComfAchi} shows the comfort achievement ratio using \ac{sgcm}, \ac{dgcm} and {rtgcm} for different subgroup sizes across four office rooms.
