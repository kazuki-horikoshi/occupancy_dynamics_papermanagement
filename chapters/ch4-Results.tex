...
Figure~\ref{fig:ImpGCDMvsRTGCM} shows the improvement ratio between the \ac{rtgcm} and \ac{dgcm}.
...
Also, \autoref{fig:ImpGCDMvsRTGCM} shows that the improvement ratio between the \ac{rtgcm} and \ac{dgcm} initially increases at the small subgroup sizes such as below 6, and converges to a stable value around at larger subgroup sizes.
...
\begin{figure}[pos=htbp!]
    \centering
    \includegraphics[width=0.7\linewidth]{\Pic{png}{analysis23_k_normalized_mean_occupancy_mean_abs_step_when_changed_heatmap_regime_style_expanded_pool_overlap_dense_ybins05pct_kle16_minn20}}
...
This can be interpreted that in general building \ac{hvac} operation, these adjustment range can be wider than controlable range, thus this adjustment magnitude can be practical in actual \ac{hvac} operation.
...
\begin{figure}[pos=htbp!]
    \centering
    \includegraphics[width=0.9\linewidth]{\Pic{png}{analysis25_final_15min_action_step_rate_by_15min_utr_member_size}}
