...
The \ac{pcm}s are developed using ordered multinominal logistic classification, used in similar agentic-based thermal comfort simulations~\cite{jung_comparative_2019, jung_energy_2020}, motivated by its interpretable representation of thermal comfort probabilities across input parameter values.
