...
The primary measurements were \ac{ti} and \ac{rh}, obtained from the \ac{bms} and compact sensors (HIOKI E.E. Corporation, Nagano, Japan) installed in the target rooms.
...
The difference between policies is therefore not the setpoint-selection rule itself, but the temporal resolution at which the group is defined.
